...
Go to the official site of Oracle:
...
Prefer: mysql-installer-community (full ~400MB) → easier (offline)
...
✔ Developer Default (if available)
Select:

Full
Click Next
Click Execute
Continue setup (password step will come)
⚠️ Very Important (Next Screen)
